<?php
/**
 *	模块：fincontractextra.合同额外收支，
 *	说明：自定义区域内可写您想要的代码，模块列表页面，生成分为2块
 *	来源：流程模块→表单元素管理→[模块.合同额外收支]→生成列表页
 */
...
<script>
    $(document).ready(function(){
        {params}
        var modenum = 'fincontractextra',modename='合同额外收支',isflow=1,modeid='86',atype = params.atype,pnum=params.pnum;
        if(!atype)atype='';if(!pnum)pnum='';
        var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"num","name":"\u5408\u540c\u7f16\u53f7","fieldstype":"selectdatafalse","ispx":"1","isalign":"0","islb":"1"},{"fields":"path","name":"\u6536\u5230\/\u652f\u51fa","fieldstype":"select","ispx":"1","isalign":"0","islb":"1"},{"fields":"money","name":"\u91d1\u989d","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"code","name":"\u7f16\u53f7","fieldstype":"num","ispx":"1","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"1","isalign":"0","islb":"1"},{"fields":"smalltype","name":"\u7c7b\u522b","fieldstype":"rockcombo","ispx":"1","isalign":"0","islb":"1"},{"fields":"paytype","name":"\u4ed8\u6b3e\u65b9\u5f0f","fieldstype":"select","ispx":"1","isalign":"0","islb":"1"},{"fields":"invoice","name":"\u6536\u5230\u53d1\u7968","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"},{"fields":"perinvoice","name":"\u62b5\u6263\u7cfb\u6570","fieldstype":"select","ispx":"1","isalign":"0","islb":"1"},{"fields":"type","name":"\u5927\u7c7b\u522b","fieldstype":"fixed","ispx":"1","isalign":"0","islb":"1"},{"fields":"paydt","name":"\u6536\/\u4ed8\u6b3e\u65e5\u671f","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"}],fieldsselarr= {"columns_fincontractextra_":"code,smalltype,num,path,money,explain,paytype,paydt,caozuo"};
        ...
        var c = {
            ...
            subscribelist:function(){
                js.subscribe({
                    title:'合同额外收支('+nowtabs.name+')',
                    cont:'合同额外收支('+nowtabs.name+')的列表的',
                    explain:'订阅[合同额外收支]的列表',
                    objtable:a
                });
            },
            getacturl:function(act){
                return js.getajaxurl(act,'mode_fincontractextra|input','flow',{'modeid':modeid});
            },
            ...
            daoru:function(){
                window.managelistfincontractextra = a;
                addtabs({num:'daorufincontractextra',url:'flow,input,daoru,modenum=fincontractextra',icons:'plus',name:'导入合同额外收支'});
            },
        ...
        var bootparams = {
            ...
            params:{atype:atype},
            columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"合同编号",dataIndex:"num",sortable:true},{text:"收到/支出",dataIndex:"path",sortable:true},{text:"金额",dataIndex:"money"},{text:"编号",dataIndex:"code",sortable:true},{text:"说明",dataIndex:"explain",sortable:true},{text:"类别",dataIndex:"smalltype",sortable:true},{text:"付款方式",dataIndex:"paytype",sortable:true},{text:"收到发票",dataIndex:"invoice",sortable:true},{text:"抵扣系数",dataIndex:"perinvoice",sortable:true},{text:"大类别",dataIndex:"type",sortable:true},{text:"收/付款日期",dataIndex:"paydt",sortable:true},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
        ...
        js.initbtn(c);
        var a = $('#viewfincontractextra_{rand}').bootstable(bootparams);
        c.init();
...
<div id="viewfincontractextra_{rand}"></div>
<!--HTMLend-->