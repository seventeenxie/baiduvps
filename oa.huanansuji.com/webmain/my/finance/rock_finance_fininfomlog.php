<?php
/**
*	模块：fininfomlog.财务操作记录，
*	说明：自定义区域内可写您想要的代码，模块列表页面，生成分为2块
*	来源：流程模块→表单元素管理→[模块.财务操作记录]→生成列表页
*/
...
$(document).ready(function(){
	{params}
	var modenum = 'fininfomlog',modename='财务操作记录',isflow=0,modeid='85',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"type","name":"\u7c7b\u578b","fieldstype":"select","ispx":"1","isalign":"0","islb":"1"},{"fields":"paytype","name":"\u652f\u4ed8\u65b9\u5f0f","fieldstype":"text","ispx":"1","isalign":"0","islb":"1"},{"fields":"money","name":"\u91d1\u989d","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"1","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'财务操作记录('+nowtabs.name+')',
				cont:'财务操作记录('+nowtabs.name+')的列表的',
				explain:'订阅[财务操作记录]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_fininfomlog|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistfininfomlog = a;
			addtabs({num:'daorufininfomlog',url:'flow,input,daoru,modenum=fininfomlog',icons:'plus',name:'导入财务操作记录'});
		},
	...
	//表格参数设定
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('ZmluaW5mb21sb2c:'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"类型",dataIndex:"type",sortable:true},{text:"支付方式",dataIndex:"paytype",sortable:true},{text:"金额",dataIndex:"money",sortable:true},{text:"说明",dataIndex:"explain",sortable:true},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewfininfomlog_{rand}').bootstable(bootparams);
	c.init();
...
<div id="viewfininfomlog_{rand}"></div>
<!--HTMLend-->