...
$(document).ready(function(){
	{params}
	var modenum = 'finsalary',modename='薪酬管理',isflow=0,modeid='79',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"money","name":"\u603b\u91d1\u989d","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"nopay","name":"\u672a\u4ed8","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"paytype","name":"\u4ed8\u6b3e\u65b9\u5f0f","fieldstype":"select","ispx":"1","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"readypay","name":"\u5df2\u652f\u4ed8\u91d1\u989d","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"},{"fields":"tempsalary","name":"\u53d1\u653e\u5de5\u8d44","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"applydt","name":"\u65e5\u671f","fieldstype":"date","ispx":"0","isalign":"0","islb":"1"},{"fields":"applyname","name":"\u59d3\u540d","fieldstype":"changeuser","ispx":"0","isalign":"0","islb":"1"},{"fields":"bonus","name":"\u5956\u91d1","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"commission","name":"\u63d0\u6210","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"type","name":"\u85aa\u916c","fieldstype":"fixed","ispx":"0","isalign":"0","islb":"1"},{"fields":"basesalary","name":"\u57fa\u672c\u5de5\u8d44","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= {"columns_finsalary_":"money,paytype,explain,readypay,nopay,applydt,applyname,bonus,commission,basesalary,caozuo"};
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'薪酬管理('+nowtabs.name+')',
				cont:'薪酬管理('+nowtabs.name+')的列表的',
				explain:'订阅[薪酬管理]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_finsalary|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistfinsalary = a;
			addtabs({num:'daorufinsalary',url:'flow,input,daoru,modenum=finsalary',icons:'plus',name:'导入薪酬管理'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"总金额",dataIndex:"money"},{text:"未付",dataIndex:"nopay"},{text:"付款方式",dataIndex:"paytype",sortable:true},{text:"说明",dataIndex:"explain"},{text:"已支付金额",dataIndex:"readypay",sortable:true},{text:"发放工资",dataIndex:"tempsalary"},{text:"日期",dataIndex:"applydt"},{text:"姓名",dataIndex:"applyname"},{text:"奖金",dataIndex:"bonus"},{text:"提成",dataIndex:"commission"},{text:"薪酬",dataIndex:"type"},{text:"基本工资",dataIndex:"basesalary"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewfinsalary_{rand}').bootstable(bootparams);
	c.init();
...
<div id="viewfinsalary_{rand}"></div>
<!--HTMLend-->